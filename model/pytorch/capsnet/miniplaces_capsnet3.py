...
class PlacesCapsuleNet(nn.Module):
    def __init__(self, reconstruction=False):
        ...
        conv2_kernel_size = 9
        conv2_stride = 2
        conv2_size = (conv1_size - conv2_kernel_size) // conv2_stride + 1
        ...
        cap1_kernel_size = 9
        cap1_stride = 2
        conv3_size = (conv2_size - cap1_kernel_size) // cap1_stride + 1
        print('Image size after conv3:', conv3_size)
        ...
        self.primary_capsules = CapsuleLayer(num_capsules=cap1_units, num_route_nodes=-1, in_channels=conv2_filters,
                                             out_channels=cap1_out_channels, kernel_size=cap1_kernel_size, stride=cap1_stride)

        self.secondary_capsules = CapsuleLayer(num_capsules=cap2_units, num_route_nodes=cap1_out_channels * conv3_size * conv3_size,
